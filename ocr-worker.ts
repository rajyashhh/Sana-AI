...
// Helper to chunk text manually to avoid heavy dependencies
...
async function reindexOCR(fileId: string, ocrText: string) {
    ...
    // Use manual chunking instead of LangChain splitter
    const chunks = chunkText(ocrText, 1000, 200);
    ...
    const index = pinecone.Index("sana-ai");
